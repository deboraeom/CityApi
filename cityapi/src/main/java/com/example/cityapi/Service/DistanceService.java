...
import com.example.cityapi.Utils.StringLocationUtils;
...
public class DistanceService {
    ...
    public Double distanceUsingPoints(final Long city1, final Long city2, final EarthRadius unit) {
        ...
        final List<City> cities = cityRepository.findAllById((Arrays.asList(city1, city2)));
        System.out.println("distanceUsingPoints"+cities.toString());
    ...
    public Double distanceByCubeInMeters(Long city1, Long city2) {
        ...
        final List<City> cities = cityRepository.findAllById((Arrays.asList(city1, city2)));
        System.out.println("distanceByCubeInMeters"+cities.toString());
